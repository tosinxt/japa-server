import { validate_signin, handle_validation_errors, validate_search, } from "../middlewares/validation/registration_val.js";
import { apply_for_jobs, find_courses, find_courses_by_id, find_job_by_id, job_applied_for, list_category, list_jobtype, login_user, apply_for_coaching, } from "../Controllers/user.js";
import { find_jobs } from "../Controllers/user.js";
import { list_technologies, list_yoe } from "../Controllers/admin.js";
export default (router) => {
    router.post("/user/login", validate_signin, handle_validation_errors, login_user);
